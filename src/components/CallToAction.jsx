...
export default function ImprovedCTA() {
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="block text-white/90">más activa de jóvenes</span>
            </h2>

            {/* Descripción */}
            <p className="text-lg md:text-xl text-white/90 mb-10 leading-relaxed">
              Conecta con estudiantes como tú, accede a recursos exclusivos y
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10 text-white">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <div className="text-2xl mb-2">💡</div>
                <p className="text-sm font-medium">Mentoría grupal</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <div className="text-2xl mb-2">🌟</div>
                <p className="text-sm font-medium">Networking activo</p>
              </div>
            </div>

            {/* Botón CTA con ícono profesional */}
            <a
              href="https://wa.me/51999999999?text=¡Hola!%20Quiero%20unirme%20a%20la%20comunidad%20EDU-US"
              target="_blank"
      ...
      <a
        href="https://wa.me/51999999999?text=¡Hola!%20Quiero%20más%20información%20sobre%20EDU-US"
        target="_blank"
        rel="noopener noreferrer"
