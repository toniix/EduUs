    ...
    <div className="relative rounded-xl overflow-hidden border border-gray-200 dark:border-gray-800">
      ...
      <div className="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
        <button
          type="button"
          onClick={() => fileInputRef.current?.click()}
          className="bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-xs font-semibold px-3 py-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
        >
          Cambiar
        </button>
        <button
