        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {offers.map((offer, index) => (
            <m.div
              ...
              key={index}
              className="group relative bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 overflow-hidden border border-transparent p-6 hover:-translate-y-2"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
              <div className="relative z-10 w-full h-full">
                <div className="w-16 h-16 rounded-2xl mb-6 flex items-center justify-center bg-primary/10 text-primary shadow-sm mx-auto group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                  <offer.icon className="w-8 h-8" strokeWidth={1.5} />
                </div>
