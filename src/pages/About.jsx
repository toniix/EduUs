        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="relative bg-white rounded-2xl p-8 h-full border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 leading-relaxed text-center">
                  ...
                  técnicas clave para la inserción laboral, conectando talento
            ...
            >
              ...
              <div className="relative bg-white rounded-2xl p-8 h-full border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 leading-relaxed text-center">
                  ...
                  instituciones educativas y organizaciones aliadas para crear
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="absolute -inset-0.5 bg-gradient-to-r from-accent/60 to-primary/60 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-all duration-400"></div>
              <div className="relative bg-white rounded-2xl p-8 h-full border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 leading-relaxed text-center">
                  ...
                  para personalizar procesos, escalar nuestro alcance e innovar
                  en la educación.
                </p>
              </div>
            </motion.div>
