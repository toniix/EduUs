...
const PrivacyPage = () => {
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <SEO
        title="Política de Privacidad | EDU-US"
        description="Conoce nuestra política de tratamiento de datos personales. EDU-US protege tu privacidad conforme a la Ley N.º 29733 de Perú."
        noindex={true}
      />
