...
const TermsPage = () => {
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <SEO
        title="Términos y Condiciones | EDU-US"
        description="Lee los términos y condiciones de uso de EDU-US. Condiciones de acceso, cuentas de usuario y propiedad intelectual."
        noindex={true}
      />
