      ...
      <section className="min-h-screen bg-secondary/10">
        <section className="container mx-auto px-4 py-8">
          ...
          <div className="lg:hidden mb-6">
            <button
              type="button"
              className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-secondary hover:bg-secondary/50"
